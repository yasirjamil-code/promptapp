  ...
  return (
    <section className=" w-full max-w-full flex-start flex-col mb-12">
      ...
      <p className=" desc text-left max-w-md">
        {type} and share amzing prompts with the world, let your imagination run
        wild with AI powered platform
      </p>
      <form
        action=""
        onSubmit={handleSubmit}
        className=" mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphisim"
      >
        <label htmlFor="">
